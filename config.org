...
#+begin_src emacs-lisp :tangle yes
(use-package shackle
  ;; FIXME When opening the Lab 6 ADC buffer (and only that buffer) some weird splits start to happen.
  :hook (after-init . shackle-mode)
  :custom
  (shackle-rules '(("*compilation*" :align t :size 0.2 :autoclose t)
		   ("\\*pytest\\*.*" :regexp t :align t :size 0.4 :autoclose t)
		   ("*Warnings*" :align t :size 0.2 :autoclose t)

		   ("*undo-tree*" :align t :size 0.4 :autoclose t)

		   ("*Org-Babel Error Output*" :align t :size 0.2 :autoclose t)
		   ;; Org prevents this from working
		   ;; ("*Org Select*" :align 'above :size 0.4 :autoclose t)
		   ;;("*Org Agenda*" :same t :autoclose t)
		   ("*ob-ipython-traceback*" :autoclose t)
		   ("*ob-ipython-out*" :autoclose t)
...
#+begin_src emacs-lisp :tangle no :noweb-ref evil-line-movement
...
(use-package lsp-mode
  ...
  :hook ((lsp-mode . (lambda ()
	 ...
	 ((c++-mode python-mode java-mode) . lsp))
  :custom
