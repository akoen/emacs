...
* TODO Reorganize to separate configuration vs functionality


* Table of Contents                                               :TOC_3_gh:
- [[#reorganize-to-separate-configuration-vs-functionality][Reorganize to separate configuration vs functionality]]
