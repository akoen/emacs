...
(use-package shackle
  ...
  :custom
  (shackle-rules '(("*compilation*" :align t :size 0.2)
		   ("\\*pytest\\*.*" :regexp t :align t :size 0.2 :select t)
		   ("*Warnings*" :align t :size 0.2 :select t)

		   ;; Dap mode
		   (".*?cppdbg.*" :regexp t :align t :size 0.2 :select t)
		   ("\\*.*?out\\*" :regexp t :align t :size 0.2 :select t)
  ...
  ;; Default behaviour from Centaur (advice-add #'keyboard-quit :before #'shackle-close-popup-window-hack)
