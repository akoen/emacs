...
(use-package smartparens
  ...
  :config
  ;; NOTE: Following config mostly stolen from Doom
  ...
  (sp-local-pair sp-lisp-modes "'" nil :actions :rem)
...
(use-package org-roam
  ...
  :general
  (leader-key
    ;; TODO Replace with org-roam-buffer-toggle once it works
    "or" 'org-roam-buffer
...
,* Top 3 Highlights")
  ...
  :config
  (org-roam-setup)
  ;; TODO Remove once org-roam-buffer-toggle works
  (set-popup-rule! "\\org-roam":side 'right)
  (set-popup-rule! "\\*org-roam\\*" :ttl nil :side 'right))
#+end_src
**** org-roam-server
...
(use-package cider
  ...
  :init
  (set-popup-rules!
    '(("^\\*cider-error*" :select t)
      ("^\\*cider-repl" :select t :ttl nil :size 0.4)
