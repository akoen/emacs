...
(use-package modus-themes
  ...
  ;; HACK: In daemon mode the cursor has a habit of taking on the background
  ;; colour. This shouldn't be necessary.
...
(use-package evil
  ...
  :config
  ;; Evil configurations cannot be set in :custom because of
...
(use-feature org-agenda
  ...
  (add-to-list 'load-path "~/Programming/gtd-agenda")
  (require 'gtd-agenda)
