...
;; FIXME Does not seem to work on server
        ...
        '(("g" "Get Things Done (GTD)"
           ((agenda nil
            ...
            (todo "NEXT"
                  ((org-agenda-skip-function
                    '(org-agenda-skip-entry-if 'deadline))
                   (org-agenda-prefix-format "   %-35(org-format-outline-path (last (org-get-outline-path)) 28 nil org-agenda-breadcrumbs-separator) %t %s")
...
(use-feature org-agenda
  :after org
  :config
  ;; From http://doc.norang.ca/org-mode.html#GTD
