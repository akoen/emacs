...
(use-package mu4e
  ...
  ;; Org-capture emails. Stolen from https://github.com/munen/emacs.d/blob/master/configuration.org#capture-templates
  ...
  (add-to-list 'org-capture-templates
		 ...
		 "* TODO %? %(from-name \"%:fromname\" \"%:fromaddress\" \"%:from\") %a"))
