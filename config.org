...
(setq org-capture-templates
      `(("t" "Todo" entry (file+headline ,(concat org-directory "refile.org") "Refile")
         "* TODO %?")
        ("p" "Project" entry (file+headline ,(concat org-directory "inbox.org") "Projects") 
         "* %?")
        ("n" "Next" entry (file+headline ,(concat org-directory "refile.org") "Refile") 
         "* NEXT %? \n:PROPERTIES:\n:TRIGGER: next-sibling todo!(\"NEXT\") chain!(\"TRIGGER\") deadline!(cp)\n:END:\n")
        ("l" "Protocol" entry (file+headline ,(concat org-directory "refile.org") "Inbox")
