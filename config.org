...
** Package Management
We are using [[https://github.com/raxod502/straight.el][straight.el]] for package management.
...
(disabled) Replace underline with highlight
...
(enabled) Custom highlight face. From [[https://emacs.stackexchange.com/questions/38216/custom-faces-in-org-9-0]]. If this stops working enable the above code.
...
(defun my/daily-review ()
  (interactive)
  (let ((org-capture-templates '(("d" "Daily Review" entry (file+datetree "~/Drive/Tasks/reviews.org")
