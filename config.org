...
(with-eval-after-load 'jupyter
  (advice-add #'jupyter-eval-region :after #'+jupyter-add-fringe-overlays))
...
(defun +jupyter-add-fringe-overlays (beg end)
  (save-excursion
    (goto-char beg)
    (while (< (point) end)
