...
(use-package example
  ...
  :init (message "I'm always here a startup")
  :config
...
(use-package exec-path-from-shell
  ...
  (setq exec-path-from-shell-arguments (delete "-i" exec-path-from-shell-arguments) 
        exec-path-from-shell-variables (nconc exec-path-from-shell-variables '("PATH" "PASSWORD_STORE_DIR SSH_AUTH_SOCK")))
...
(use-package org-caldav
  :custom
  (org-caldav-url "http://galah:5232/alex")
  (org-caldav-calendar-id "32a980f4-ce6d-e46d-143c-2baeb2a8d7bf")
  ...
  ;; (org-icalendar-include-todo t) ; not supported by org-caldav
  ...
  :config
  (run-with-idle-timer 30 t #'org-caldav-sync))
#+end_src
...
(use-package latex
  ...
  (general-imap :keymaps 'TeX-mode-map
    "C-f" #'+latex-insert-inkscape-figure)
