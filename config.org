...
(use-package hydra
  ...
  (defhydra hydra-window ()
    ...
    ("h" evil-window-left "left" :exit t :column "Move")
    ...
    ("C-h" shrink-window-horizontally "←" :column "Resize")
    ("C-j" enlarge-window "↓")
    ("C-k" shrink-window "↑")
    ...
    ("r" evil-window-split "horizontally" :column "Split" :exit t)
    ("v" evil-window-vsplit "vertically" :exit t)
